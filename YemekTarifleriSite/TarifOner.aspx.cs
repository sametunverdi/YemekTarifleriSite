...
namespace YemekTarifleriSite
{
    public partial class TarifOner : System.Web.UI.Page
    {
        ...
        {
            SqlCommand komut = new SqlCommand("insert into Tbl_Tarifler (TarifAd,TarifMalzeme,TarifYapilis,TarifResim,TarifSahip,TarifMail) values (@t1,@t2,@t3,@t4,@t5,@t6)", bgl.baglanti());
